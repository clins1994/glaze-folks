...
export function registerHandlers(): void {
  ...
  // Folks community relay status + anonymous-first identity
  registerIdentityHandlers();

  // Folks community bootstrap, presence, and handshake (network features)
  registerCommunityHandlers();

  // Folks discovery: private AI topic extraction + global matching + rooms
